...
// Declaration of leaf types
   ...
   Int_t           Reco_QQ_trig[210];   //[Reco_QQ_size]
   Int_t 	   Reco_QQ_mupl_trig[210];   //[Reco_QQ_size]
   Int_t           Reco_QQ_mumi_trig[210];   //[Reco_QQ_size]
   ...
   Bool_t          Reco_QQ_mupl_isHighPurity[210];   //[Reco_QQ_size]
   Bool_t          Reco_QQ_mumi_isHighPurity[210];   //[Reco_QQ_size]
   ...
   Int_t           Reco_mu_SelectionType[40];   //[Reco_mu_size]
   Int_t           Reco_mu_charge[40];   //[Reco_mu_size]
   TClonesArray    *Reco_mu_4mom;
   Int_t           Reco_mu_trig[40];   //[Reco_mu_size]
   Bool_t          Reco_mu_isGoodMuon[40];   //[Reco_mu_size]
   ...
   Int_t           Reco_mu_nPixValHits[40];   //[Reco_mu_size]
...
void initOniaTree(TChain *tree)
{
   ...
   if (fChain->GetBranch("Reco_QQ_mupl_isHighPurity")) fChain->SetBranchAddress("Reco_QQ_mupl_isHighPurity", Reco_QQ_mupl_isHighPurity, &b_Reco_QQ_mupl_isHighPurity);
   if (fChain->GetBranch("Reco_QQ_mumi_isHighPurity")) fChain->SetBranchAddress("Reco_QQ_mumi_isHighPurity", Reco_QQ_mumi_isHighPurity, &b_Reco_QQ_mumi_isHighPurity);
   ...
   if (fChain->GetBranch("Reco_mu_isHighPurity")) fChain->SetBranchAddress("Reco_mu_isHighPurity", Reco_mu_isHighPurity, &b_Reco_mu_isHighPurity);
